import { createEntityAdapter, createSlice, createSelector, createAction, isAnyOf, EntityState } from '@reduxjs/toolkit'
...
export const { selectAll: selectAllNotificationsMetadata, selectEntities: selectMetadataEntities } =
  metadataAdapter.getSelectors((state: RootState) => state.notifications as EntityState<NotificationMetadata>)
